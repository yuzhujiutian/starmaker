...
# -------------------------------------------------------
    # 登录弹窗-语言选择界面文案
    def LogInPopup_Languagedisplay_Copywriting(self):
        LogInPopup_Languagedisplay_MCopywriting_ClaS = self.findClaS(LogIn_VD.Source_LogIn_Languagedisplay_CopywritingClaS,
                                                                     0)
        return LogInPopup_Languagedisplay_MCopywriting_ClaS

        # 选择语言

    def LogInPopup_Chooselanguage_English(self):
        LogInPopup_Chooselanguage_English_Text = self.findAU("new UiSelector().text(\"English\")")
        return LogInPopup_Chooselanguage_English_Text

        # 选择语言后sing页面出现的引导

    def LogInPopup_Noviceguide(self):
        LogInPopup_Noviceguide_Text = self.findAU("new UiSelector().text(\"Win Diamonds by daily check-in!\")")
        return LogInPopup_Noviceguide_Text

        # 页面底部的“Me”

    def LogInPopup_SelectbarMe(self):
        LogInPopup_SelectbarMe_Clas = self.findClaS(LogIn_VD.Source_LogIn_MeClas, 4)
        return LogInPopup_SelectbarMe_Clas

        # 登录方式-更多

    def LogInPopup_SelectLoginMode_MoreWay(self):
        LogInPopup_SelectLoginMode_MoreWay_ClaS = self.findClaS(LogIn_VD.Source_LogIn_MoreWayClaS, 2)
        return LogInPopup_SelectLoginMode_MoreWay_ClaS

        # 登录方式-更多-邮箱LogInPopup_SelectLoginMode_SelectEmail

    # def LogInPopup_SelectLoginMode_SelectEmail(self):
    #     LogInPopup_SelectLoginMode_SelectEmail_ID = self.findID(LY_VD.LogInPopup_SelectLoginMode_SelectEmail_ID)
    #     return LogInPopup_SelectLoginMode_SelectEmail_ID

        # 选择邮箱-Log_in

    def LogInPopup_SelectLoginMode_LogIn(self):
        LogInPopup_SelectLoginMode_LogIn_ID = self.findID(LogIn_VD.LogInPopup_SelectLoginMode_LogIn_ID)
        return LogInPopup_SelectLoginMode_LogIn_ID

        # 输入邮箱

    def LogInPopup_SelectLoginMode_SendEmail(self):
        LogInPopup_SelectLoginMode_SendEmail_ID = self.findID(LogIn_VD.LogInPopup_SendEmail_ID)
        return LogInPopup_SelectLoginMode_SendEmail_ID

        # 输入密码

    def LogInPopup_SelectLoginMode_SendPw(self):
        LogInPopup_SelectLoginMode_SendPw_ID = self.findAU("new UiSelector().text(\"Password\")")
        return LogInPopup_SelectLoginMode_SendPw_ID

        # 点击登录

    def LogInPopup_EmailLoginMode_LogIn(self):
        LogInPopup_EmailLoginMode_LogIn_ID = self.findID(LogIn_VD.EmailWay_LogIn_ID)
        return LogInPopup_EmailLoginMode_LogIn_ID

        # Me页面的用户名称

    def LogInPopup_LogIn_UserName(self):
        LogInPopup_LogIn_UserName_ID = self.findID(LogIn_VD.Source_EmailWay_MeUserName_ID)
        return LogInPopup_LogIn_UserName_ID
