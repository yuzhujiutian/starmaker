...
class Home(object):
    ...
    # Sing页面-中下方四个Tab([*]Trending)
    def SingPage_SingHeat_Trending(self, num):
        SingPage_SingHeat_Trending_IDS = self.findIDS(Home_VD.SingPage_SingHeat_IDS, num)
        return SingPage_SingHeat_Trending_IDS
    ...
    # Sing页面-任一Tab下-第一首歌曲
    def SingPage_CommonTab_FirstSong(self):
        SingPage_CommonTab_FirstSong_ID_IDS = self.ID_IDS(Home_VD.SingPage_CommonTab_FirstSong)
        return SingPage_CommonTab_FirstSong_ID_IDS
