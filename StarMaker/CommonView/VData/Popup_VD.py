...
Popup_ImgClose_ID = package + mapping_dict[Source_Popup_ImgClose_ID]

# 通用——iv关闭弹窗
Source_Popup_IvClose_ID = "iv_close"
Popup_IvClose_ID = package + mapping_dict[Source_Popup_IvClose_ID]
...
Popup_Guide_Text_ID = package + mapping_dict[Source_Popup_GuideText_ID]

# ②③登录后首页 Ranking/Parties 引导 NEXT按钮/DONE按钮
Source_Popup_Guide_Next_ID = "next_tv"
Popup_Guide_Next_ID = package + mapping_dict[Source_Popup_Guide_Next_ID]

# 签到按钮，如果存在，需点击通用close按钮
Source_Popup_CheckIn_ID = "btn_check_in"
Popup_CheckIn_ID = package + mapping_dict[Source_Popup_CheckIn_ID]
...
Popup_VerifyEmail_Verify_ID = package + mapping_dict[Source_Popup_VerifyEmail_Verify_ID]
...
Popup_PostGuide_ID = package + mapping_dict[Source_Popup_PostGuide_ID]
...
Popup_Jurisdiction_ID = package + mapping_dict[Source_Popup_Jurisdiction_ID]
...
Popup_HeadphonesRecommended_ID = package + mapping_dict[Source_Popup_HeadphonesRecommended_ID]

# 音效引导(text=Change the song's pitch to match \n your voice!]
Source_Popup_PitchGuide_ID = "tv_pitch_guide_tip"
Popup_PitchGuide_ID = package + mapping_dict[Source_Popup_PitchGuide_ID]
...
Popup_LivePage_Slide_ID = package + mapping_dict[Source_Popup_LivePage_Slide_ID]

# Live悬浮窗引导 拒绝按钮(text=REFUSE]
Source_Popup_LivePage_MinimizeOption_RefuseBtn_ID = "md_buttonDefaultNegative"
Popup_LivePage_MinimizeOption_RefuseBtn_ID = package + mapping_dict[Source_Popup_LivePage_MinimizeOption_RefuseBtn_ID]

# KTV悬浮窗引导 拒绝按钮(text=REFUSE]
Source_Popup_KTVPage_MinimizeOption_RefuseBtn_ID = "bt_left"
Popup_KTVPage_MinimizeOption_RefuseBtn_ID = package + mapping_dict[Source_Popup_KTVPage_MinimizeOption_RefuseBtn_ID]
