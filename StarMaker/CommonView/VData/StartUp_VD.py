...
ChooseGenderPage_CheckTitle_Tips_ID = package + mapping_dict[Source_ChooseGenderPage_CheckTitle_Tips_ID]

# 性别选择页-性别选择-男性
Source_ChooseGenderPage_ChooseGender_Man_ID = "txt_choose_gender_male"
ChooseGenderPage_ChooseGender_Man_ID = package + mapping_dict[Source_ChooseGenderPage_ChooseGender_Man_ID]

# 性别选择页-性别选择-女性
Source_ChooseGenderPage_ChooseGender_Woman_ID = "txt_choose_gender_female"
ChooseGenderPage_ChooseGender_Woman_ID = package + mapping_dict[Source_ChooseGenderPage_ChooseGender_Woman_ID]
