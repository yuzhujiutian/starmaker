...
Source_ChooseLanguagePage_SelectLanguage_Common_IDS = "txt_language_english"
ChooseLanguagePage_SelectLanguage_Common_IDS = package + mapping_dict[Source_ChooseLanguagePage_SelectLanguage_Common_IDS]
