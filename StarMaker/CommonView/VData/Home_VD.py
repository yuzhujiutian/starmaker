...
HomePage_Common_Search_ID = package + mapping_dict[Source_HomePage_Common_Search_ID]
...
HomePage_ChooseLanguage_IndiaTips_ID = package + mapping_dict[Source_HomePage_ChooseLanguage_IndiaTips_ID]
...
HomePage_ChooseLanguage_IndiaSwitchLanguage_IDS = package + \
                                                  mapping_dict[Source_HomePage_ChooseLanguage_IndiaSwitchLanguage_IDS]
...
HomePage_HotTopics_Text_ID = package + mapping_dict[Source_HomePage_HotTopics_Text_ID]

# 首页-HotTopics-SeeAll(English_text=SEE ALL]
Source_HomePage_HotTopics_SeeAll_ID = "txt_trend_recommend_action"
HomePage_HotTopics_SeeAll_ID = package + mapping_dict[Source_HomePage_HotTopics_SeeAll_ID]
...
HomePage_FeedCard_Delete_ID_IDS = package + mapping_dict[Source_HomePage_FeedCard_Delete_ID_IDS]

# 首页-feed卡片_头像(ID/IDS]
Source_HomePage_FeedCard_HeadView_ID_IDS = "civ_head_view"
HomePage_FeedCard_HeadView_ID_IDS = package + mapping_dict[Source_HomePage_FeedCard_HeadView_ID_IDS]

# 首页-feed卡片_用户名(ID/IDS]
Source_HomePage_FeedCard_UserName_ID_IDS = "user_name_view_tv_name"
HomePage_FeedCard_UserName_ID_IDS = package + mapping_dict[Source_HomePage_FeedCard_UserName_ID_IDS]

# 首页-feed卡片_Follow(English_text=FOLLOW](ID/IDS]
Source_HomePage_FeedCard_Follow_ID_IDS = "v_follow"
HomePage_FeedCard_Follow_ID_IDS = package + mapping_dict[Source_HomePage_FeedCard_Follow_ID_IDS]

# 首页-feed卡片_叉号(ID/IDS]
Source_HomePage_FeedCard_Dislike_ID_IDS = "close_tweet"
HomePage_FeedCard_Dislike_ID_IDS = package + mapping_dict[Source_HomePage_FeedCard_Dislike_ID_IDS]

# 首页-feed卡片_描述(ID/IDS]
Source_HomePage_FeedCard_Describe_ID_IDS = "tv_desc"
HomePage_FeedCard_Describe_ID_IDS = package + mapping_dict[Source_HomePage_FeedCard_Describe_ID_IDS]

# 首页-feed卡片_图片(ID/IDS]
Source_HomePage_FeedCard_Img_ID_IDS = "img_recording_cover"
HomePage_FeedCard_Img_ID_IDS = package + mapping_dict[Source_HomePage_FeedCard_Img_ID_IDS]

# 首页-feed卡片_视屏(ID/IDS]
Source_HomePage_FeedCard_Video_ID_IDS = "iv_image"
HomePage_FeedCard_Video_ID_IDS = package + mapping_dict[Source_HomePage_FeedCard_Video_ID_IDS]

# 首页-feed卡片_分享按钮(ID/IDS]
Source_HomePage_FeedCard_Share_ID_IDS = "layout_share"
HomePage_FeedCard_Share_ID_IDS = package + mapping_dict[Source_HomePage_FeedCard_Share_ID_IDS]
...
HomePage_FeedCard_CommentCount_ID_IDS = package + mapping_dict[Source_HomePage_FeedCard_CommentCount_ID_IDS]

# 首页-feed卡片_like按钮(ID/IDS]
Source_HomePage_FeedCard_Like_ID_IDS = "layout_like"
HomePage_FeedCard_Like_ID_IDS = package + mapping_dict[Source_HomePage_FeedCard_Like_ID_IDS]
...
HomePage_FeedCard_WhatsApp_ID_IDS = package + mapping_dict[Source_HomePage_FeedCard_WhatsApp_ID_IDS]
...
HomePage_DislikePop_Unwanted_ID = package + mapping_dict[Source_HomePage_DislikePop_Unwanted_ID]

# 首页-Dislike弹窗-Report
Source_HomePage_DislikePop_Report_ID = "tv_report"
HomePage_DislikePop_Report_ID = package + mapping_dict[Source_HomePage_DislikePop_Report_ID]

# 首页-Dislike弹窗-Cancel
Source_HomePage_DislikePop_Cancel_ID = "tv_cancel"
HomePage_DislikePop_Cancel_ID = package + mapping_dict[Source_HomePage_DislikePop_Cancel_ID]
...
HomePage_SharePop_Frame_ID = package + mapping_dict[Source_HomePage_SharePop_Frame_ID]

# 首页-WhatsApp弹窗-外框
Source_HomePage_WhatsAppPop_Frame_ID = "ly_fragment_share_video_switch_dialog"
HomePage_WhatsAppPop_Frame_ID = package + mapping_dict[Source_HomePage_WhatsAppPop_Frame_ID]
...
HomePage_MainTab_IDS = package + mapping_dict[Source_HomePage_MainTab_IDS]

# 首页-底部五个Tab名称([0]Moment/[1]Party/[2]Sing/[3]Message/[4]Me]
Source_HomePage_MainTab_TabName_IDS = "tab_name"
HomePage_MainTab_TabName_IDS = package + mapping_dict[Source_HomePage_MainTab_TabName_IDS]
...
SingPage_Function_CheckSingTitle_ID = package + mapping_dict[Source_SingPage_Function_CheckSingTitle_ID]

# Sing页面-搜索框
Source_SingPage_Common_Search_ID = "txt_search"
SingPage_Common_Search_ID = package + mapping_dict[Source_SingPage_Common_Search_ID]

# Singy页面-播放器图标
Source_SingPage_Common_Player_ID = "music_wave_bar"
SingPage_Common_Player_ID = package + mapping_dict[Source_SingPage_Common_Player_ID]
...
SingPage_SingHeat_IDS = package + mapping_dict[Source_SingPage_SingHeat_IDS]

# Sing页面-任一Tab下-第一个歌曲
Source_SingPage_CommonTab_FirstSong = "ll_content"
SingPage_CommonTab_FirstSong = package + mapping_dict[Source_SingPage_CommonTab_FirstSong]

# Sing页面-Recommend下的歌曲点击SING
Source_SingPage_SingRecommend_SelectSing_IDS = "btn_sing"
SingPage_SingRecommend_SelectSing_IDS = package + mapping_dict[Source_SingPage_SingRecommend_SelectSing_IDS]
...
SingPage_SingRecommend_SingType_IDS = package + mapping_dict[Source_SingPage_SingRecommend_SingType_IDS]
...
SingSolo_SingGuide_ID = package + mapping_dict[Source_SingSolo_SingGuide_ID]

# Sing页面-选择歌曲-Solo-引导信息确认
Source_SingSolo_SingGuideConfirm_ID = "recording_headset_dialog_i_know_btn"
SingSolo_SingGuideConfirm_ID = package + mapping_dict[Source_SingSolo_SingGuideConfirm_ID]

# Sing页面-选择歌曲-Solo-Pitch引导信息确认
Source_SingSolo_PitchGuide_ID = "tv_pitch_guide_tip"
SingSolo_PitchGuide_ID = package + mapping_dict[Source_SingSolo_PitchGuide_ID]

# Sing页面-选择歌曲-Solo-歌曲Pitch
Source_SingSolo_CheckPitch_ID = "record_pitch_btn"
SingSolo_CheckPitch_ID = package + mapping_dict[Source_SingSolo_CheckPitch_ID]

# Sing页面-选择歌曲-Solo-歌曲Volume
Source_SingSolo_CheckVolume_ID = "volume_btn"
SingSolo_ChecVolume_ID = package + mapping_dict[Source_SingSolo_CheckVolume_ID]

# Sing页面-选择歌曲-Solo-歌曲Start
Source_SingSolo_CheckStart_ID = "record_btn"
SingSolo_CheckStart_ID = package + mapping_dict[Source_SingSolo_CheckStart_ID]

# Sing页面-选择歌曲-Solo-歌曲Guide
Source_SingSolo_CheckGuide_ID = "guide_btn"
SingSolo_CheckGuide_ID = package + mapping_dict[Source_SingSolo_CheckGuide_ID]

# Sing页面-选择歌曲-Solo-歌曲Effect
Source_SingSolo_CheckEffect_ID = "audio_effect_btn"
SingSolo_CheckEffect_ID = package + mapping_dict[Source_SingSolo_CheckEffect_ID]

# Sing页面-选择歌曲-Solo-歌曲名称
Source_SingSolo_SingName_ID = "song_name_tv"
SingSolo_SingName_ID = package + mapping_dict[Source_SingSolo_SingName_ID]

# Sing页面-选择歌曲-Solo-音频和视频唱歌
Source_SingSolo_AudioVideo_ID = "song_name_tv"
SingSolo_AudioVideo_ID = package + mapping_dict[Source_SingSolo_AudioVideo_ID]

# Sing页面-选择歌曲-Solo-返回上一页
Source_SingSolo_BackPage_ID = "back_img"
SingSolo_BackPage_ID = package + mapping_dict[Source_SingSolo_AudioVideo_ID]

# Sing页面-选择歌曲-Solo-温馨提示图标
Source_SingSolo_TipsIcon_ID = "rl_title_fragment_record_tip"
SingSolo_TipsIcon_ID = package + mapping_dict[Source_SingSolo_TipsIcon_ID]


# Sing页面-选择歌曲-Solo-温馨提示信息
Source_SingSolo_TipInfo_ID = "rl_title_fragment_record_tip"
SingSolo_TipsInfo_ID = package + mapping_dict[Source_SingSolo_TipInfo_ID]

# Sing页面-选择歌曲-Solo-播放歌曲-歌曲打分
Source_SingSolo_SingRecordScore_ID = "pb_progress_view_record_score"
SingSolo_SingRecordScore_ID = package + mapping_dict[Source_SingSolo_SingRecordScore_ID]

# Sing页面-选择歌曲-Solo-播放歌曲-歌曲打分头像
Source_SingSolo_SingRecordScoreImage_ID = "iv_avatar_view_record_score"
SingSolo_SingRecordScoreImage_ID = package + mapping_dict[Source_SingSolo_SingRecordScoreImage_ID]

# Sing页面-选择歌曲-Solo-播放歌曲-歌曲音准器（上面的抖动条）
Source_SingSolo_SongTone_ID = "intonation_view"
SingSolo_SongTone_ID = package + mapping_dict[Source_SingSolo_SongTone_ID]
...
SongTone_PitchPage_PitchTitle_ID = package + mapping_dict[Source_SongTone_PitchPage_PitchTitle_ID]

# Pitch界面的-Close
Source_SongTone_PitchPage_PitchClose_ID = "done_tv"
SongTone_PitchPage_PitchClose_ID = package + mapping_dict[Source_SongTone_PitchPage_PitchClose_ID]

# Pitch界面的-"-"(低调节]
Source_SongTone_PitchPage_PitchLower_ID = "img_lower_pitch"
SongTone_PitchPage_PitchLower_ID = package + mapping_dict[Source_SongTone_PitchPage_PitchLower_ID]

# Pitch界面的-“+”（高调节）
Source_SongTone_PitchPage_PitchRaise_ID = "img_raise_pitch"
SongTone_PitchPage_PitchRaise_ID = package + mapping_dict[Source_SongTone_PitchPage_PitchRaise_ID]

# Pitch界面的-“----”（调节条）
Source_SongTone_PitchPage_PitchProgressBar_ID = "pitchTrayProgressBar"
SongTone_PitchPage_PitchProgressBar_ID = package + mapping_dict[Source_SongTone_PitchPage_PitchProgressBar_ID]

# Pitch界面的-分数（调节分数）
Source_SongTone_PitchPage_PitchContent_ID = "tv_pitch_content"
SongTone_PitchPage_PitchContent_ID = package + mapping_dict[Source_SongTone_PitchPage_PitchContent_ID]
...
SongTone_VolumePage_VolumeAdjust_ID = package + mapping_dict[Source_SongTone_VolumePage_VolumeAdjust_ID]

# VOLUME界面的-Volume-Music
Source_SongTone_VolumePage_MusicAdjust_ID = "volumeTrayMusicTv"
SongTone_VolumePage_MusicAdjust_ID = package + mapping_dict[Source_SongTone_VolumePage_MusicAdjust_ID]
...
SongTone_EffectPage_SceneEffect_IDS = package + mapping_dict[Source_SongTone_EffectPage_SceneEffect_IDS]
