...
SignUp_Tips_ID = package + FS(Source_SignUp_Tips_ID)
...
SignUp_Input_Box_ID = package + FS(Source_SignUp_Input_Box_ID)

# SignUp 下一步
Source_SignUp_Next_Btn_ID = "com_accountkit_next_button"
SignUp_Next_Btn_ID = package + FS(Source_SignUp_Next_Btn_ID)

# SignUp 报错信息
Source_SignUp_InputEmail_Error_ID = "textinput_error"
SignUp_InputEmail_Error_ID = package + FS(Source_SignUp_InputEmail_Error_ID)

# SignUp 打开邮箱
Source_SignUp_OpenEmail_ID = "com_accountkit_check_email_button"
SignUp_OpenEmail_ID = package + FS(Source_SignUp_OpenEmail_ID)

# SignUp 重发邮件
Source_SignUp_ResendEmail_ID = "com_accountkit_retry_email_button"
SignUp_ResendEmail_ID = package + FS(Source_SignUp_ResendEmail_ID)
